...
const PostList = ({ username }) => {
    ...
    return (
        <div className="text-white">
            ...
            <p className="text-2xl text-center mb-6 text-white">Nickname: {username}</p>
            {posts.map((post) => (
                <div
                    key={post.id}
                    className="border-2 border-amber-600 rounded-lg p-4 mb-4 flex justify-between items-center"
                ...
                >
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <img
                            ...
                            src={post.is_liked ? assets.like1 : assets.unlike1}
            ...
            <div className="flex justify-between mt-4">
                <button
                    ...
                    disabled={page === 1}
                    className="bg-main text-white px-4 py-2 rounded disabled:opacity-50 hover:scale-105 transition-all duration-300 focus:outline-none"
                >
                    Previous
                </button>
                <button
                    onClick={() => setPage(page + 1)}
                    className="bg-main text-white px-4 py-2 rounded hover:scale-105 transition-all duration-300 focus:outline-none"
                >
                    Next
                </button>
            </div>
